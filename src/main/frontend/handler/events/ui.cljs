...
;; No Cognito/JWKS. We synthesize a local session so the sync UI unlocks and the
;; client talks to the local db-sync adapter (run with DB_SYNC_DISABLE_AUTH=true).
