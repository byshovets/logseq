...
`dev-selfhost.sh` (run the local stack), `smoke-test.js` (the A->B end-to-end
check), and `editor-durability-hardening.patch` (the separate editor-durability
change from PLAN.md 7b/Phase 5).
